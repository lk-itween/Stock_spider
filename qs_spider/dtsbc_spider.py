...
Origin: https://www.dtsbc.com.cn
Sec-Fetch-Site: same-origin
Sec-Fetch-Mode: cors
Sec-Fetch-Dest: empty
Referer: https://www.dtsbc.com.cn/main/ywzx/rzrq/gsxx/dbzqjzsl/index.html
...
class db(object):
    ...
    def parse_html(self, html, exc=0):
        ...
        df_columns = {'market': '市场', 'sec_code': '证券代码', 'sec_name': '证券简称', 'dbzsl': '折算率',
...
class rzrq(object):
    ...
    def parse_html(self, html, label='融资标的', exc=0):
        ...
        df_columns = {'market': '市场', 'sec_code': '证券代码', 'sec_name': '证券简称', 'rzbzjbl': '融资保证金比例',
                      '融券保证金比例': '融券保证金比例', 'xgrq': '日期', '保证金比例': '保证金比例', '保证金比例（%）': '保证金比例',
                      'underlyingType': '标的类别'}
        #         df['融资保证金比例'] = '是'
        #         df['融券保证金比例'] = '是'
        #######################################
