...
Origin: https://www.hrsec.com.cn
Sec-Fetch-Site: same-origin
Sec-Fetch-Mode: cors
Sec-Fetch-Dest: empty
Referer: https://www.hrsec.com.cn/main/jfrsc/grrz/rzrq/gsxx/bdzqjbzj/index.shtml
...
class db(object):
    ...
    ########  需要修改的部分
    urlo = 'https://www.hrsec.com.cn/servlet/rzrq/RzrqAction'
    stock_name = '华融证券'
    post = True  # 数据请求方式
    ...
    # 构造请求数据字典
    def post_data(self, page_num=1, label='getkdc', N1=page_size):
        """ post: data参数
        每次重新编辑需要修改
        """
        datapost = {
    ...
    def parse_html(self, html, exc=0):
        ...
        df_columns = {'交易所': '市场', '证券代码': '证券代码', '证券简称': '证券简称', '折算率': '折算率',
                      'createTime': '日期', '状态': '状态', }
...
class rzrq(object):
    ...
    def parse_html(self, html, label='融资标的', exc=0):
        ...
        df_columns = {'交易所': '市场', '证券代码': '证券代码', '证券简称': '证券简称', '融资保证金比例': '融资保证金比例',
