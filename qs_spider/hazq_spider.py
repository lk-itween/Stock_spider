...
Referer: http://www.hazq.com/main/companybusiness/creditbusiness/securitieslendingborrowing/publicinformation/marginsecurities/index.shtml
...
class db(object):
    ...
    ########  需要修改的部分
    urlo = 'http://www.hazq.com/main/servlet/json'
    stock_name = '华安证券'
    post = True  # 数据请求方式
    ...
    def parse_html(self, html, exc=0):
        ...
        df_columns = {'exchange': '市场', 'stock_code': '证券代码', 'stock_name': '证券简称', 'conversion_rate': '折算率',
...
class rzrq(object):
    ...
    def parse_html(self, html, label='融资标的', exc=0):
        ...
        df_columns = {'exchange': '市场', 'stock_code': '证券代码', 'stock_name': '证券简称', 'fin_ratio': '融资保证金比例',
