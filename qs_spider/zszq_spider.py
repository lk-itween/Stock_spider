...
h_txt = """Host: www.zszq.com
Connection: keep-alive
Content-Length: 26
Accept: */*
X-Requested-With: XMLHttpRequest
Content-Type: application/x-www-form-urlencoded; charset=UTF-8
Origin: http://www.zszq.com
Referer: http://www.zszq.com/rzrq/zsl
...
class db(object):
    ...
    urlo = 'http://www.zszq.com/yxry/conversionrate'
    ...
    def parse_html(self, html, label='可担保物', exc=0):
        ...
        df_columns = {'rzrqzsl_jys': '市场', 'rzrqzsl_gpdm': '证券代码', 'rzrqzsl_gpjc': '证券简称', 'rzrqzsl_zsl': '折算率',
                      'ctime': '日期'}
...
class rzrq(object):
    ...
    date0 = datetime.datetime.now()
    date1 = date0.strftime('%Y%m%d')
    urlo = 'http://www.zszq.com/yxry/credittarget'
