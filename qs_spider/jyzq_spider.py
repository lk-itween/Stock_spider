...
h_txt = '''Host: www.jyzq.cn
Connection: keep-alive
Content-Length: 73
Accept: application/json, text/javascript, */*; q=0.01
X-Requested-With: XMLHttpRequest
Content-Type: application/x-www-form-urlencoded; charset=UTF-8
Origin: http://www.jyzq.cn
Referer: http://www.jyzq.cn/osoa/views/main/Credit_business/Margin_trading/conversionRate.shtml
...
class db(object):
    ...
    ########  需要修改的部分
    urlo = 'http://www.jyzq.cn/servlet/json'
    stock_name = '金元证券'
    post = True  # 数据请求方式
    ...
    # 构造请求数据字典
    def post_data(self, page_num=1, label='501042', N1=page_size):
        """ post: data参数
        每次重新编辑需要修改
        """
        datapost = {
    ...
    def parse_html(self, html, exc=0):
        ...
        df_columns = {'exchangeType': '市场', 'STOCK_CODE': '证券代码', 'STOCK_NAME': '证券简称', 'ASSURE_RATIO': '折算率',
...
class rzrq(object):
    ...
    def parse_html(self, html, label='融资标的', exc=0):
        ...
        df_columns = {'exchangeType': '市场', 'STOCK_CODE': '证券代码', 'STOCK_NAME': '证券简称', 'finRatio': '融资保证金比例',
                      '融券保证金比例': '融券保证金比例', 'INIT_DATE': '日期', 'BAIL_RATIO': '保证金比例', '保证金比例（%）': '保证金比例',
