...
h_txt = '''Host: info.hx168.com.cn
Connection: keep-alive
Content-Length: 85
Accept: application/json, text/javascript, */*; q=0.01
X-Requested-With: XMLHttpRequest
Content-Type: application/x-www-form-urlencoded; charset=UTF-8
Origin: http://info.hx168.com.cn
Referer: http://info.hx168.com.cn/ywzx/rzrq/gsxx/bzjzsl.shtml
...
class db(object):
    ...
    ########  需要修改的部分
    urlo = 'http://info.hx168.com.cn/servlet/json'
    stock_name = '华西证券'
    post = True  # 数据请求方式
    ...
    def parse_html(self, html, exc=0):
        ...
        try:
            ...
            try:
                pageOrTotal = df_json['DataSet1'][0]['total_rows']
                ...
                pageOrTotal = 0
            df = pd.DataFrame(df_json['DataSet0'])
        ...
        df_columns = {'stockstation': '市场', 'stockcode': '证券代码', 'stockname': '证券简称', 'pledgerage': '折算率',
                      'createTime': '日期', '状态': '状态', }
...
class rzrq(object):
    ...
    def parse_html(self, html, label='融资标的', exc=0):
        ...
        df_columns = {'stockstation': '市场', 'stockcode': '证券代码', 'stockname': '证券简称', '融资保证金比例': '融资保证金比例',
                      '融券保证金比例': '融券保证金比例', 'createTime': '日期', 'ratio': '保证金比例', '保证金比例（%）': '保证金比例',
                      'underlyingType': '标的类别'}
        df['融资保证金比例'] = '是'
        df['融券保证金比例'] = '是'
        #######################################
